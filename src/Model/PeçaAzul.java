...
public class PeçaAzul extends Peça{
   ...
   public PeçaAzul(int casaAtual, Point locationBase){
    ...
    public PeçaAzul(Point locationBase) {
        super.locationBase = locationBase;
        cor = CorPeça.AZUL;
        preencheCaminho();
        naBase = true;
    ...
    protected final void preencheCaminho() {
        caminho = new Point[]{
            ...
            new Point(905,305),new Point(870,305),new Point(835,305),new Point(800,305),new Point(765,305),new Point(730,305),new Point(695,305),new Point(660,305), new Point(625,305)
