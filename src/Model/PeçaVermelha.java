...
public class PeçaVermelha extends Peça {
    ...
    @Override
    public final void preencheCaminho() {
        ...
        caminho = new Point[]{
            ...
            new Point(600,0),new Point(600,35),new Point(600,70),new Point(600,105),new Point(600,140),new Point(600,175),new Point(600,210),new Point(600,245),new Point(600,280)
